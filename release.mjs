...
/*
* Script to release the seats.io android lib.
...
async function bumpVersionInFiles() {
    await replaceInFile("./seatsio-android-component/build.gradle", `version = '${latestVersion}'`, `version = '${nextVersion}'`)
    await replaceInFile("README.md", `'io.seats:seatsio-android:${latestVersion}'`, `'io.seats:seatsio-android:${nextVersion}'`)
